$(document).ready(function () {
	...
	const startGame = () => {
		...
		characterSelection = [knight,elf,orc,wizard];
	...
	$("#attack").on("click", function() {
		...
		if(character !== null && character.healthPoints > 0 && defenders.length > 0) {
			...
			if(defender !== null) {
				...
				status += "You Attacked The " + defender.name + " For " + character.attackPower + " Damage.<br>";
				...
				status += "The " + defender.name + " Attacked You Back For " + defender.counterAttackPower + " Damage.<br>";
				...
				if(character.healthPoints <= 0) {
					...
					status = "You Have Defeated The " + defender.name + ", Please Choose Another Enemy To Continue.";
